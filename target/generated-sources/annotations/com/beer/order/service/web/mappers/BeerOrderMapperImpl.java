...
import com.beer.order.service.domain.BeerOrder.BeerOrderBuilder;
import com.beer.order.service.domain.BeerOrderLine;
import com.beer.order.service.web.model.BeerOrderDto;
import com.beer.order.service.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import com.beer.order.service.web.model.BeerOrderLineDto;
import com.beer.order.service.web.model.OrderStatusEnum;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(com.beer.order.service.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected com.beer.order.service.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        com.beer.order.service.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = com.beer.order.service.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = com.beer.order.service.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = com.beer.order.service.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
