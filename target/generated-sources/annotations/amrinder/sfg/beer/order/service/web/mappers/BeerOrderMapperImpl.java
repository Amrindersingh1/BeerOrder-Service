...
import amrinder.sfg.beer.order.service.domain.BeerOrder;
import amrinder.sfg.beer.order.service.domain.BeerOrder.BeerOrderBuilder;
import amrinder.sfg.beer.order.service.domain.BeerOrderLine;
import amrinder.sfg.beer.order.service.web.model.BeerOrderDto;
import amrinder.sfg.beer.order.service.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import amrinder.sfg.beer.order.service.web.model.BeerOrderLineDto;
import amrinder.sfg.beer.order.service.web.model.OrderStatusEnum;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(amrinder.sfg.beer.order.service.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected amrinder.sfg.beer.order.service.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        amrinder.sfg.beer.order.service.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = amrinder.sfg.beer.order.service.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = amrinder.sfg.beer.order.service.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = amrinder.sfg.beer.order.service.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
